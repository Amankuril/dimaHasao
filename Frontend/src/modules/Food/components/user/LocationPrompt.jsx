...
export default function LocationPrompt() {
  ...
  return (
    ...
    >
      ...
      >
        <button
          className="absolute right-4 top-4 text-[#0a4d2b] hover:text-[#06381e] transition-all p-1.5 rounded-full bg-red-50 hover:bg-red-100 dark:bg-red-950/40 dark:hover:bg-red-900/60 shadow-sm active:scale-95 duration-200"
        ...
        <div className="relative mb-5 mt-4">
          ...
          <div className="relative h-16 w-16 rounded-full bg-red-50 dark:bg-red-950/30 flex items-center justify-center ring-8 ring-red-100/50 dark:ring-red-950/10">
            <MapPin className="h-8 w-8 text-[#0a4d2b]" />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2.5 mt-6 w-full">
          <button
            onClick={handleAllow}
            className="w-full h-12 rounded-full bg-[#0a4d2b] hover:bg-[#06381e] text-white font-semibold text-sm transition-all duration-200 shadow-lg shadow-red-600/10 flex items-center justify-center disabled:opacity-85"
