                    ...
                    <div className="flex items-center justify-between h-16 gap-4">
                            ...
                            {showLogo && (
                                <Link to="/food/user" className="flex items-center justify-center flex-shrink-0">
                                    {logoUrl || companyName ? (
                                        ...
                                        <img src={CONSUMER_BRAND_LOGO} onError={logoFallback} alt={companyName || "Logo"} className="h-10 w-auto md:h-14 lg:h-16 object-contain" />
                                    )}
                                </Link>
                            )}
                        ...
                        <div className="flex-1 max-w-3xl mx-4 flex items-center gap-4">
                            ...
                            <div className="relative flex-1">
                                <div className="relative bg-gray-100 dark:bg-[#2a2a2a] rounded-lg transition-all duration-300 focus-within:ring-2 focus-within:ring-[#0a4d2b] focus-within:bg-white dark:focus-within:bg-[#1a1a1a] border border-transparent focus-within:border-[#0a4d2b]/20">
                        ...
                        <div className="flex items-center space-x-12 lg:space-x-16 xl:space-x-20">
                            ...
                            <Link
                                ...
                                className={`flex flex-col items-center gap-1 px-2 py-1 transition-colors relative group ${isDelivery
                                    ? "text-[#0a4d2b]"
                                    : "text-gray-600 dark:text-gray-400 hover:text-[#0a4d2b]"
                                    }`}
                            >
                                ...
                                {isDelivery && (
                                    <motion.div
                                        ...
                                        className="absolute -bottom-3 left-0 right-0 h-0.5 bg-[#0a4d2b]"
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
