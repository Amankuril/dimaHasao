        ...
        {itemCount > 0 && !shouldHidePill && (
          ...
          >
            <button
              ...
              className={`bg-gradient-to-r from-[#06381e] via-[#0a4d2b] to-[#06381e] text-white rounded-full shadow-xl shadow-[#0a4d2b]/30 px-3 py-2 flex items-center gap-2 hover:from-[#06381e] hover:via-[#0a4d2b] hover:to-[#06381e] transition-all duration-300 pointer-events-auto border border-[#0a4d2b]/30 backdrop-blur-sm cursor-pointer touch-manipulation ${pillClassName}`}
            >
