                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full h-14 pl-12 pr-4 bg-white dark:bg-[#1a1a1a] border border-slate-100 dark:border-white/10 rounded-2xl font-bold text-slate-900 dark:text-white focus:outline-none focus:ring-4 focus:ring-red-500/10 focus:border-[#0a4d2b] transition-all placeholder:text-slate-300 dark:placeholder:text-slate-600"
                            />
                        </div>
                    </div>
                ...
                <div className="pt-10">
                    <button
                        ...
                        className={`w-full h-14 rounded-2xl font-black uppercase tracking-widest text-sm transition-all flex items-center justify-center gap-3 ${
                            hasChanged && !saving
                                ? "bg-gradient-to-br from-[#0a4d2b] to-[#7f1010] text-white active:scale-95 shadow-[0_4px_16px_rgba(220,38,38,0.4)]"
