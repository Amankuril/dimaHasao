  ...
  const goBack = useAppBackNavigation()
    ...
    return (
        <AnimatedPage className="bg-slate-50 dark:bg-slate-950 min-h-screen pb-24 transition-colors">
            {/* Header */}
            <div className="bg-[#0a4d2b] text-white px-4 py-4 sticky top-0 z-50 shadow-md">
            ...
            <div className="p-4 space-y-4">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 overflow-hidden">
                    <div className="p-4 space-y-4">
                        <div className="flex items-start gap-3">
                            <div className="bg-[#faf6ed] dark:bg-slate-800 p-2 rounded-xl">
                                <Calendar className="w-5 h-5 text-[#0a4d2b]" />
                            </div>
                             <div>
                ...
                >
                    <div className="flex items-center gap-3">
                        <div className={`p-2 rounded-xl transition-colors ${specialRequest ? 'bg-purple-50 dark:bg-purple-950/30' : 'bg-slate-100 dark:bg-slate-800 group-hover:bg-slate-200 dark:group-hover:bg-slate-700'}`}>
                            <Info className={`w-5 h-5 ${specialRequest ? 'text-[#0a4d2b]' : 'text-slate-600 dark:text-slate-400'}`} />
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        {specialRequest && (
                            <span className="text-[10px] font-black text-[#0a4d2b]/40 uppercase tracking-widest">Edit</span>
                        )}
                ...
                <div className="pt-4">
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            <div className="flex items-start gap-3">
                                <div className="text-[#0a4d2b] dark:text-purple-400 mt-1">
            ...
            <div className="fixed bottom-0 left-0 w-full bg-white dark:bg-[#0d0d0d] border-t border-slate-100 dark:border-white/5 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] z-50">
                <Button
                    ...
                    className="w-full h-14 bg-[#0a4d2b] hover:bg-[#06381e] text-white font-bold text-lg rounded-2xl transition-all active:scale-[0.98] disabled:opacity-60"
                >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3 pt-1">
                                ...
                                <button
                                    ...
                                    className="h-12 rounded-xl bg-[#0a4d2b] text-white font-bold text-sm uppercase tracking-widest shadow-lg shadow-red-200 dark:shadow-none active:scale-95 transition-all"
                                >
                                    Save
                                </button>
                            </div>
