      ...
      <div className="relative w-full overflow-hidden h-[30vh] sm:h-[35vh] md:h-[40vh] shadow-2xl">
        ...
        <div className="absolute bottom-8 left-6 md:left-10 z-10 space-y-2">
          <div className="flex items-center gap-2">
            <span className="w-8 h-[2px] bg-[#0a4d2b]" />
                ...
                visibleGourmetRestaurants.map((item) => {
                  ...
                  return (
                    <Link key={restaurantId} to={`/user/restaurants/${restaurantSlug}`}>
                      <Card className="overflow-hidden cursor-pointer border-0 group bg-white dark:bg-[#1a1a1a] shadow-xl shadow-gray-200/20 dark:shadow-none hover:shadow-2xl hover:shadow-[#0a4d2b]/5 transition-all duration-500 py-0 rounded-[32px] mb-4 group active:scale-[0.98]">
                        {/* Image Section */}
                        <div className="relative h-48 sm:h-56 md:h-60 w-full overflow-hidden rounded-t-[32px]">
                          ...
                          <div className="absolute bottom-4 right-4 flex items-center gap-1.5 bg-white px-3 py-1.5 rounded-2xl shadow-2xl">
                             ...
                             <Star className="h-3.5 w-3.5 fill-[#0a4d2b] text-[#0a4d2b]" />
                          </div>
                        </div>
                        ...
                        <CardContent className="p-5">
                          ...
                          <div className="flex items-center justify-between gap-2 mb-3">
                            <h3 className="text-xl font-black text-gray-900 dark:text-gray-100 truncate group-hover:text-[#0a4d2b] transition-colors">
                          ...
                          <div className="flex items-center gap-4 text-[12px] text-gray-500 dark:text-gray-400 mb-4 font-bold uppercase tracking-tight">
                            <div className="flex items-center gap-1.5">
                              <Clock className="h-4 w-4 text-[#0a4d2b]" strokeWidth={2.5} />
                          ...
                          {/* Offer Badge */}
                          {restaurant.offer ? (
                            <div className="flex items-center gap-2.5 px-3 py-2 bg-[#0a4d2b]/5 dark:bg-[#0a4d2b]/10 rounded-2xl w-fit">
                              <BadgePercent className="h-4 w-4 text-[#0a4d2b]" strokeWidth={3} />
                              <span className="text-[10px] font-black text-[#0a4d2b] uppercase tracking-wider">{restaurant.offer}</span>
                            </div>
                          ) : (
