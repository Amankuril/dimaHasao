        ...
        <div className="flex items-center gap-6 z-10">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="animate-cloche-float mb-0.5">
              <svg className="w-20 h-16 text-[#0a4d2b] dark:text-[#E11D48] fill-red-500/10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-[#0a0a0a]">
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="mt-8"
              >
                <div className="w-8 h-8 border-2 border-[#0a4d2b] border-t-transparent rounded-full animate-spin mx-auto" />
              ...
              >
                <div className="flex items-center justify-center gap-2 text-[#0a4d2b] dark:text-orange-400 font-medium cursor-pointer hover:opacity-80 transition-opacity" onClick={() => navigate('/user/profile/report-safety-emergency', { state: { returnTo: location.pathname } })}>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-4 md:py-6 space-y-4 md:space-y-6 pb-24 md:pb-32">
        ...
        {orderStatus === 'delivered' && !isOrderRated && (
          <motion.div
            className={`bg-white dark:bg-[#1a1a1a] rounded-xl p-6 shadow-sm border-2 border-[#0a4d2b]/10 relative overflow-hidden group transition-all duration-200 ${
              isLocalRated 
          ...
          >
            ...
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-[#0a4d2b]/5 rounded-full blur-2xl group-hover:bg-[#0a4d2b]/10 transition-colors" />
            
            <div className="flex flex-col items-center text-center relative z-10">
              <div className="w-16 h-16 bg-[#0a4d2b]/10 dark:bg-[#0a4d2b]/20 rounded-full flex items-center justify-center mb-4 transition-transform group-hover:scale-110 duration-300">
                <Star className="w-8 h-8 text-[#0a4d2b] fill-[#0a4d2b]" />
              </div>
              ...
              <Button 
                ...
                className={`w-full max-w-[200px] font-bold h-12 rounded-xl border-none shadow-lg transition-all duration-150 ${
                  isLocalRated
                    ...
                    : "bg-[#0a4d2b] hover:bg-[#06381e] text-white shadow-[#0a4d2b]/20"
                }`}
              >
        ...
        >
          <div className="flex items-center gap-3 p-4 border-b border-dashed border-gray-200 dark:border-gray-800">
            ...
            <div className="flex flex-col gap-2 shrink-0">
              ...
              >
                <Navigation className="w-5 h-5 text-[#0a4d2b]" />
              </motion.button>
              <motion.button
                className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center shadow-sm"
              ...
              >
                <Phone className="w-5 h-5 text-[#0a4d2b]" />
              </motion.button>
            </div>
          </div>
          ...
          <div className="p-6 pt-4 space-y-6 max-h-[70vh] overflow-y-auto">
            ...
            {order?.note && (
              <div className="bg-orange-50/50 rounded-xl p-4 border border-orange-100 flex gap-3">
                ...
                <div>
                  <p className="text-xs text-[#0a4d2b] dark:text-red-400 font-bold uppercase tracking-wider mb-1">Delivery Instructions</p>
        ...
        <DialogContent className="sm:max-w-md w-[95vw] rounded-3xl p-6 border-0 shadow-2xl bg-white dark:bg-[#1a1a1a] max-h-[90vh] overflow-y-auto z-[200]">
          ...
          <div className="space-y-4">
            ...
            <Textarea
              ...
              className="min-h-[120px] resize-none border-gray-200 focus:ring-[#0a4d2b] rounded-xl bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 text-base"
            />
            <Button 
              onClick={handleUpdateInstructions} 
              disabled={isUpdatingInstructions}
              className="w-full bg-[#0a4d2b] hover:bg-[#06381e] text-white font-bold h-12 rounded-xl border-none transition-colors"
            >
        ...
        <DialogContent className="sm:max-w-md w-[95vw] rounded-3xl p-6 border-0 shadow-2xl bg-white dark:bg-[#1a1a1a] max-h-[90vh] overflow-y-auto">
          <DialogHeader className="mb-2">
            <DialogTitle className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
              <Star className="w-6 h-6 text-[#0a4d2b] fill-[#0a4d2b]" />
          ...
          <div className="space-y-6 py-2">
            ...
            <Button
              ...
              className="w-full bg-[#0a4d2b] hover:bg-[#06381e] text-white font-bold h-14 rounded-2xl shadow-lg mt-4"
            >
