      ...
      <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] flex items-center justify-center">
        <div className="text-center space-y-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-[#0a4d2b] text-white text-sm font-semibold hover:bg-[#06381e] transition-all active:scale-95 shadow-md"
          >
            Back to Orders
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] pb-24 font-sans relative">
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-white dark:bg-[#121212] p-4 rounded-xl shadow-sm border dark:border-gray-800">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="w-8 h-8 rounded-full border border-[#0a4d2b]/20 flex items-center justify-center text-[#0a4d2b] hover:bg-[#0a4d2b]/5"
            >
        ...
        {order && order.status === "delivered" && (
          <button
            ...
            className="w-full bg-[#0a4d2b]/5 border border-[#0a4d2b]/20 text-[#0a4d2b] py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#0a4d2b]/10 transition-colors"
          >
        ...
        <div className="bg-white dark:bg-[#121212] rounded-xl shadow-sm overflow-hidden border dark:border-gray-800">
          <div className="p-4 flex justify-between items-center border-b border-gray-100 dark:border-gray-800">
            ...
            <button
              ...
              className="w-7 h-7 rounded-full bg-[#0a4d2b]/10 flex items-center justify-center text-[#0a4d2b] hover:bg-[#0a4d2b]/20 transition-colors"
            >
            ...
            {order.orderType !== "takeaway" && order.orderType !== "dining" && (
              <div className="flex justify-between">
                ...
                {pricing.deliveryFee === 0 && (
                  <span className="text-[#0a4d2b] text-[10px] font-bold border border-[#0a4d2b] px-1 rounded ml-1">
                    FREE
                  </span>
                )}
                <span className="text-[#0a4d2b] dark:text-[#a04882] font-medium uppercase">
          ...
          {/* Savings Banner */}
          {savings > 0 && (
            <div className="relative bg-[#0a4d2b]/5 p-3 pb-4 mt-2">
              ...
              <div className="flex items-center justify-center gap-2 pt-1 text-[#0a4d2b] font-bold text-sm">
                <span></span>
                <span>
      ...
      <div className="fixed bottom-0 w-full bg-white dark:bg-[#121212] border-t border-gray-200 dark:border-gray-800 p-4 flex gap-3 z-20">
        <button
          ...
          className="flex-1 bg-[#0a4d2b] text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#06381e] transition-all active:scale-95 shadow-md"
        >
        ...
        <button
          type="button"
          onClick={handleDownloadSummary}
          className="flex-1 bg-white dark:bg-[#1a1a1a] border border-[#0a4d2b] text-[#0a4d2b] py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#0a4d2b]/5 transition-colors"
        >
          <Download className="w-4 h-4" />
          Invoice
        </button>
