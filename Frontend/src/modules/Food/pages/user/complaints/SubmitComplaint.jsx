    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-white p-4 flex items-center sticky top-0 z-20 shadow-sm">
        ...
        <button
          ...
          className="ml-auto text-sm font-semibold text-[#0a4d2b]"
        >
          View History
        </button>
      </div>
      ...
      <form onSubmit={handleSubmit} className="mx-4 mt-4 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0a4d2b] focus:border-transparent"
            required
          >
        ...
        <div>
          ...
          <textarea
            ...
            rows={6}
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0a4d2b] focus:border-transparent resize-none"
            required
            maxLength={1000}
          />
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-20">
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-[#0a4d2b] text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#06381e] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {submitting ? (
              <>
