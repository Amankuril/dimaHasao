...
export default function ReportSafetyEmergency() {
  ...
  return (
    <AnimatedPage className="min-h-screen bg-[#faf6ed] dark:bg-[#0a0a0a] pb-24 md:pb-0">
          ...
          <CardContent className="p-5 md:p-6 relative">
            ...
            <div className="flex items-start gap-4 relative z-10">
              <div className="bg-red-100 dark:bg-red-900/50 rounded-full p-3 md:p-3.5 mt-0.5 shadow-sm">
                <Phone className="h-5 w-5 md:h-6 md:w-6 text-[#0a4d2b] dark:text-red-400" />
              </div>
              <div className="flex-1">
                ...
                <a
                  href="tel:100"
                  className="inline-flex items-center justify-center bg-white dark:bg-[#222] text-[#0a4d2b] dark:text-red-400 border border-red-100 dark:border-red-900/30 font-bold text-base md:text-lg px-6 py-2.5 rounded-xl shadow-sm hover:shadow-md hover:bg-red-50 dark:hover:bg-red-900/20 transition-all active:scale-95"
                >
          ...
          <>
            ...
            <Card className="bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-[0_2px_15px_rgba(0,0,0,0.02)] border border-slate-100 dark:border-gray-800 mb-5 md:mb-6">
              <CardContent className="p-5 md:p-6">
                ...
                />
                <p className={`text-xs md:text-sm mt-3 flex justify-between font-medium ${report.trim().length < 10 ? 'text-[#0a4d2b]' : 'text-slate-500 dark:text-gray-400'}`}>
            ...
            <Button
              ...
              className="w-full bg-[#0a4d2b] hover:bg-[#06381e] text-white font-semibold text-base h-12 md:h-14 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_4px_14px_rgba(220,38,38,0.25)] hover:shadow-[0_6px_20px_rgba(220,38,38,0.3)] transition-all active:scale-[0.98]"
            >
              {isSubmitting ? (
                <>
