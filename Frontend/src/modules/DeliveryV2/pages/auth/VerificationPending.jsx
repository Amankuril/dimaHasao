...
const DELIVERY_PRIMARY_BTN =
  "h-12 w-full rounded-full text-base font-semibold bg-gradient-to-r from-[#0A4D2B] to-[#06381E] hover:from-[#0F6B3C] hover:to-[#06381E] text-white shadow-[0_8px_20px_rgba(14,75,156,0.25)] active:scale-[0.98] transition-all duration-300"
            ...
            {isRejected ? (
              <div className="flex items-center justify-center my-2 select-none">
                <div className="relative flex items-center" style={{ height: "36px" }}>
                  <div
                    className="bg-[#0A4D2B] text-white pl-8 pr-10 py-1.5 rounded-l-md font-black uppercase tracking-widest text-[13px] flex items-center justify-center shadow-[0_4px_10px_rgba(14,75,156,0.3)]"
                    style={{
                  ...
                  <div
                    className="absolute left-[-16px] top-1/2 -translate-y-1/2 w-8 h-8 bg-[#0A4D2B] border-[3px] border-white rotate-45 flex items-center justify-center shadow-lg"
                    style={{ zIndex: 10 }}
                  >
          ...
          <div className="mb-4 sm:mb-6 rounded-2xl border border-slate-200 bg-slate-50 p-3.5 sm:p-4">
            <div className="flex items-start gap-3">
              {isRejected ? (
                ...
                <>
                  <ShieldCheck className="mt-0.5 h-5 w-5 text-[#0A4D2B]" />
                  <div className="text-sm text-slate-700">
