...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Tours Overview" subtitle="Packages, bookings and takings across the module." />
      ...
      {/* A queue, so it links straight to the filtered list. */}
      ...
      <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <p className="text-[11px] text-gray-400 mt-4">
          Gross is the full trip value; the district collects all of it, so there is no
          commission to take and no payout to settle.
        </p>
      </div>
    </div>
  );
