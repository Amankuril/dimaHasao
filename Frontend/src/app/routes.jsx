...
// Consumer modules have exactly one login: the Dima Hasao (v1) screen.
// Anything under /food/user or /taxi/user requires that session first.
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/food/user/*" element={<FoodUserShell />} />
