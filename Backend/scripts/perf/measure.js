...
const run = async () => {
  ...
  const targets = [
    ...
    // Taxi is the largest module by endpoint count; these are the reads a
    // rider's screens actually hit on the way to booking something.
    ['taxi', 'taxi bootstrap', 'GET', '/taxi/users/bootstrap', user],
    ['taxi', 'taxi me', 'GET', '/taxi/users/me', user],
    ['taxi', 'taxi app modules', 'GET', '/taxi/users/app-modules', user],
    ['taxi', 'taxi service locations', 'GET', '/taxi/users/service-locations', user],
    ['taxi', 'taxi notifications', 'GET', '/taxi/users/notifications', user],
    ['taxi', 'taxi rental vehicles', 'GET', '/taxi/users/rental-vehicles', user],
    ['taxi', 'taxi intercity packages', 'GET', '/taxi/users/intercity-packages', user],
    ['taxi', 'taxi bus routes', 'GET', '/taxi/users/buses/routes', user],
    ['taxi', 'taxi bus bookings', 'GET', '/taxi/users/bus-bookings', user],
    ['taxi', 'taxi rental bookings', 'GET', '/taxi/users/rental-bookings', user],
    ['taxi', 'taxi subscription plans', 'GET', '/taxi/users/subscriptions/plans', user],
    ['taxi', 'taxi active ride', 'GET', '/taxi/rides/active/me', user],
    ['taxi', 'taxi user home management', 'GET', '/taxi/user-home-management', user],
    ['taxi', 'taxi goods types', 'GET', '/taxi/users/goods-types', user],
    ...
    ['festivals', 'festival detail', 'GET', '/festivals?limit=1', user],
